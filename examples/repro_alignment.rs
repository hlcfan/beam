...
use iced::{Color, Element, Font, Length, Pixels, Rectangle, Size, Theme};

pub fn main() -> iced::Result {
    iced::application(|| ((), iced::Task::none()), update, view)
        .title(|_state: &()| "Alignment Repro".to_string())
        .run()
}
...
fn case<'a>(label: &'static str, alignment: text::Alignment) -> Element<'a, ()> {
    column![
        widget_text(label),
